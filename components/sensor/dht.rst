...
- **model** (*Optional*, int): Manually specify the DHT model, can be
  ...
  and helps with some connection issues. Defaults to ``AUTO_DETECT``.  Auto detection doesn't work for the SI7021 chip. A DHT12 in Single Bus Mode should be registered as DHT11.
